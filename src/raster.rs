...
mod test {
    ...
    fn raster_mask() {
        ...
        let v = vec![
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x40, 0x20, 0x80, 0x00, 0x00,
    ...
    fn smaller_mask() {
        ...
        let c: Rgba8 =
            Rgb::with_alpha(0x40, 0xFF, 0x80, Translucent::new(Ch8::new(0x80)));
        m.set_pixel(0, 0, 0xFF);
        ...
        let v = vec![
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0xFF, 0x80, 0x80, 0x20, 0x80,
            0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x10, 0x40, 0x20, 0x20, 0x08,
            0x20, 0x10, 0x10,
        ];
